<template>
<uni-shadow-root class="@vant-weapp-dist-tabbar-index"><view :class="(border ? 'van-hairline--top-bottom' : '')+' '+(utils.bem('tabbar', { fixed, safe: safeAreaInsetBottom }))+' custom-class'" :style="zIndex ? 'z-index: ' + zIndex : ''">
  <slot></slot>
</view>
...
global['__wxRoute'] = '@vant/weapp/dist/tabbar/index'
...
export default global['__wxComponents']['@vant/weapp/dist/tabbar/index']
</script>
