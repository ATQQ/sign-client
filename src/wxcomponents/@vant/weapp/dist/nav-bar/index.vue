<template>
<uni-shadow-root class="@vant-weapp-dist-nav-bar-index"><view v-if="fixed && placeholder" :style="'height: '+(height)+'px;'"></view>
...
global['__wxRoute'] = '@vant/weapp/dist/nav-bar/index'
...
export default global['__wxComponents']['@vant/weapp/dist/nav-bar/index']
</script>
