<template>
<uni-shadow-root class="@vant-weapp-dist-notify-index"><van-transition name="slide-down" :show="show" custom-class="van-notify__container" :custom-style="computed.rootStyle({ zIndex, top })" @click.native="onTap">
...
global['__wxRoute'] = '@vant/weapp/dist/notify/index'
...
export default global['__wxComponents']['@vant/weapp/dist/notify/index']
</script>
