<template>
<uni-shadow-root class="@vant-weapp-dist-tag-index"><view :class="'custom-class '+(utils.bem('tag', [type, size, { mark, plain, round }]))" :style="computed.rootStyle({ plain, color, textColor })">
  <slot></slot>
...
global['__wxRoute'] = '@vant/weapp/dist/tag/index'
...
export default global['__wxComponents']['@vant/weapp/dist/tag/index']
</script>
