<template>
<uni-shadow-root class="@vant-weapp-dist-checkbox-index"><view class="van-checkbox custom-class">
...
global['__wxRoute'] = '@vant/weapp/dist/checkbox/index'
...
export default global['__wxComponents']['@vant/weapp/dist/checkbox/index']
</script>
