<template>
<uni-shadow-root class="@vant-weapp-dist-collapse-item-index"><view :class="'van-collapse-item custom-class '+(index !== 0 ? 'van-hairline--top' : '')">
...
global['__wxRoute'] = '@vant/weapp/dist/collapse-item/index'
...
export default global['__wxComponents']['@vant/weapp/dist/collapse-item/index']
</script>
