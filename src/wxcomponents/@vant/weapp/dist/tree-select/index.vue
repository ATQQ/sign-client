<template>
<uni-shadow-root class="@vant-weapp-dist-tree-select-index"><view class="van-tree-select" :style="'height: '+(utils.addUnit(height))">
...
global['__wxRoute'] = '@vant/weapp/dist/tree-select/index'
...
export default global['__wxComponents']['@vant/weapp/dist/tree-select/index']
</script>
