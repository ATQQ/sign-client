<template>
<uni-shadow-root class="@vant-weapp-dist-submit-bar-index"><view class="van-submit-bar custom-class">
  <slot name="top"></slot>
...
global['__wxRoute'] = '@vant/weapp/dist/submit-bar/index'
...
export default global['__wxComponents']['@vant/weapp/dist/submit-bar/index']
</script>
