<template>
<uni-shadow-root class="@vant-weapp-dist-goods-action-index"><view :class="'custom-class '+(utils.bem('goods-action', { safe: safeAreaInsetBottom }))">
  <slot></slot>
...
global['__wxRoute'] = '@vant/weapp/dist/goods-action/index'
...
export default global['__wxComponents']['@vant/weapp/dist/goods-action/index']
</script>
