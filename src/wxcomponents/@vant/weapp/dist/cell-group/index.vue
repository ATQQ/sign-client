<template>
<uni-shadow-root class="@vant-weapp-dist-cell-group-index"><view v-if="title" class="van-cell-group__title">
  {{ title }}
</view>
...
global['__wxRoute'] = '@vant/weapp/dist/cell-group/index'
...
export default global['__wxComponents']['@vant/weapp/dist/cell-group/index']
</script>
