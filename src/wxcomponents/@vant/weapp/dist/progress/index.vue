<template>
<uni-shadow-root class="@vant-weapp-dist-progress-index"><view class="van-progress custom-class" :style="computed.rootStyle({ strokeWidth, trackColor })">
...
global['__wxRoute'] = '@vant/weapp/dist/progress/index'
...
export default global['__wxComponents']['@vant/weapp/dist/progress/index']
</script>
