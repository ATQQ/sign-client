<template>
<uni-shadow-root class="@vant-weapp-dist-panel-index"><view class="van-panel van-hairline--top-bottom custom-class">
...
global['__wxRoute'] = '@vant/weapp/dist/panel/index'
...
export default global['__wxComponents']['@vant/weapp/dist/panel/index']
</script>
