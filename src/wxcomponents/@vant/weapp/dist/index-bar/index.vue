<template>
<uni-shadow-root class="@vant-weapp-dist-index-bar-index"><view class="van-index-bar">
  <slot></slot>
...
global['__wxRoute'] = '@vant/weapp/dist/index-bar/index'
...
export default global['__wxComponents']['@vant/weapp/dist/index-bar/index']
</script>
