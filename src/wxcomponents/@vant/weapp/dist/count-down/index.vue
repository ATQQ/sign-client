<template>
<uni-shadow-root class="@vant-weapp-dist-count-down-index"><view class="van-count-down">
...
global['__wxRoute'] = '@vant/weapp/dist/count-down/index'
...
export default global['__wxComponents']['@vant/weapp/dist/count-down/index']
</script>
