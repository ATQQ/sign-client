<template>
<uni-shadow-root class="@vant-weapp-dist-skeleton-index"><view v-if="loading" :class="'custom-class '+(utils.bem('skeleton', [{animate}]))">
...
global['__wxRoute'] = '@vant/weapp/dist/skeleton/index'
...
export default global['__wxComponents']['@vant/weapp/dist/skeleton/index']
</script>
