<template>
<uni-shadow-root class="@vant-weapp-dist-calendar-components-month-index"><view class="van-calendar__month" :style="computed.getMonthStyle(visible, date, rowHeight)">
...
global['__wxRoute'] = '@vant/weapp/dist/calendar/components/month/index'
...
export default global['__wxComponents']['@vant/weapp/dist/calendar/components/month/index']
</script>
