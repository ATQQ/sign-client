<template>
<uni-shadow-root class="@vant-weapp-dist-index-anchor-index"><view class="van-index-anchor-wrapper" :style="wrapperStyle">
...
global['__wxRoute'] = '@vant/weapp/dist/index-anchor/index'
...
export default global['__wxComponents']['@vant/weapp/dist/index-anchor/index']
</script>
