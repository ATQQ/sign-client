<template>
<uni-shadow-root class="@vant-weapp-dist-picker-toolbar"><view v-if="showToolbar" class="van-picker__toolbar toolbar-class">
...
global['__wxRoute'] = '@vant/weapp/dist/picker/toolbar'

Component({})

export default global['__wxComponents']['@vant/weapp/dist/picker/toolbar']
</script>
