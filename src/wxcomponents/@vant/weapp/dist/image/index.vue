<template>
<uni-shadow-root class="@vant-weapp-dist-image-index"><view :style="computed.rootStyle({ width, height, radius })" :class="'custom-class '+(utils.bem('image', { round }))" @click="onClick">
...
global['__wxRoute'] = '@vant/weapp/dist/image/index'
...
export default global['__wxComponents']['@vant/weapp/dist/image/index']
</script>
