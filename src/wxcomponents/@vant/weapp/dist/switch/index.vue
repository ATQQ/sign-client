<template>
<uni-shadow-root class="@vant-weapp-dist-switch-index"><view :class="(utils.bem('switch', { on: checked === activeValue, disabled }))+' custom-class'" :style="computed.rootStyle({ size, checked, activeColor, inactiveColor })" @click="onClick">
...
global['__wxRoute'] = '@vant/weapp/dist/switch/index'
...
export default global['__wxComponents']['@vant/weapp/dist/switch/index']
</script>
