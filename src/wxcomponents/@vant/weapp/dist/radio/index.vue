<template>
<uni-shadow-root class="@vant-weapp-dist-radio-index"><view :class="(utils.bem('radio', [direction]))+' custom-class'">
...
global['__wxRoute'] = '@vant/weapp/dist/radio/index'
...
export default global['__wxComponents']['@vant/weapp/dist/radio/index']
</script>
