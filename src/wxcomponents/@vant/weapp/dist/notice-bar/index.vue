<template>
<uni-shadow-root class="@vant-weapp-dist-notice-bar-index"><view v-if="show" :class="'custom-class '+(utils.bem('notice-bar', { withicon: mode, wrapable }))" :style="computed.rootStyle({ color, backgroundColor, background })" @click="onClick">
...
global['__wxRoute'] = '@vant/weapp/dist/notice-bar/index'
...
export default global['__wxComponents']['@vant/weapp/dist/notice-bar/index']
</script>
