<template>
<uni-shadow-root class="@vant-weapp-dist-loading-index"><view :class="'custom-class '+(utils.bem('loading', { vertical }))">
...
global['__wxRoute'] = '@vant/weapp/dist/loading/index'
