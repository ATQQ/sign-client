<template>
	<view class="p20">
		<view>
			...
			<van-checkbox-group style="display: flex; justify-content: space-around" :value="methods"
				@change="handleChange">
		...
		<view v-if="methods.includes('2')">
			...
			<view class="p20">
				<van-button type="info" block round @click="getNowLocation">刷新重置</van-button>
			</view>
			<view class="p20">
				<van-button type="primary" block round @click="chooseLocation">精准选择签到位置</van-button>
			</view>
			<map :scale="17" enable-poi enable-indoorMap @tap="handleTapMap" show-compass enable-overlooking
				show-location enable-3D :markers="markers" style="width: 100%;height: 375rpx;"
		...
		<view class="p20">
			<van-button :disabled="!isOk" size="large" @click="handleCreate" type="primary" round>确认创建</van-button>
		</view>
	</view>
</template>
